...
const SeedPhraseBackupModal = ({
  mnemonic,
  onConfirm,
  onBack,
  isLoading
}) => {
  const [hasConfirmed, setHasConfirmed] = reactExports.useState(false);
  ...
  const handleCopy = async () => {
    try {
      ...
      setTimeout(() => setCopyStatus(""), 2e3);
    } catch {
      setCopyStatus("Failed to copy");
      setTimeout(() => setCopyStatus(""), 2e3);
    }
  };
  return /* @__PURE__ */ jsxs("div", { className: "seed-phrase-modal card", children: [
    /* @__PURE__ */ jsx("div", { className: "accent-bar" }),
    /* @__PURE__ */ jsx("h2", { children: "Back Up Your Seed Phrase" }),
    /* @__PURE__ */ jsx("p", { className: "warning-banner", children: "⚠️ Write down these 12 words in order and keep them safe. Anyone with these words can access your wallet." }),
    /* @__PURE__ */ jsxs("div", { style: {
      position: "relative"
    }, children: [
      /* @__PURE__ */ jsx("div", { className: "seed-phrase-box", children: mnemonic.split(" ").map((word, index) => /* @__PURE__ */ jsxs("div", { className: "seed-word", children: [
        /* @__PURE__ */ jsx("span", { className: "word-number", children: index + 1 }),
        /* @__PURE__ */ jsx("span", { className: "word", children: word })
      ] }, index)) }),
      /* @__PURE__ */ jsx("button", { type: "button", "aria-label": "Copy seed phrase", className: "secondary-button", style: {
        position: "absolute",
        top: 10,
        right: 10,
        padding: "4px 12px",
        fontSize: "0.95em",
        zIndex: 2
      }, onClick: handleCopy, children: copyStatus ? copyStatus : "Copy" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "confirmation-checkbox", children: [
      /* @__PURE__ */ jsx("input", { type: "checkbox", id: "backup-confirm", checked: hasConfirmed, onChange: (e2) => setHasConfirmed(e2.target.checked) }),
      /* @__PURE__ */ jsx("label", { htmlFor: "backup-confirm", children: "I have backed up my seed phrase in a secure location" })
    ] }),
    error && /* @__PURE__ */ jsx("div", { className: "error-message", children: error }),
    /* @__PURE__ */ jsxs("div", { className: "button-group", children: [
      /* @__PURE__ */ jsx("button", { onClick: onBack, className: "secondary-button", disabled: isLoading, children: "Back" }),
      /* @__PURE__ */ jsx("button", { onClick: handleConfirm, className: "primary-button", disabled: isLoading || !hasConfirmed, children: isLoading ? "Creating Wallet..." : "I Have Backed Up My Seed Phrase" })
    ] })
  ] });
};
const CreateWallet = ({
  ...
  const handlePasswordSubmit = async (e2) => {
    e2.preventDefault();
    setError(null);
  ...
  if (step === "password") {
    return /* @__PURE__ */ jsxs("div", { className: "create-wallet-container card", children: [
      /* @__PURE__ */ jsx("div", { className: "accent-bar" }),
      /* @__PURE__ */ jsx("h2", { children: "Create New Wallet" }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handlePasswordSubmit, children: [
        error && /* @__PURE__ */ jsx("div", { className: "error-message", children: error }),
        /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "password", children: "Create Password" }),
          /* @__PURE__ */ jsx("input", { type: "password", id: "password", value: password, onChange: (e2) => setPassword(e2.target.value), placeholder: "Create a strong password (min. 8 characters)", disabled: isLoading, required: true, minLength: 8 }),
          /* @__PURE__ */ jsx("small", { children: "This password will be used to protect your wallet" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "confirmPassword", children: "Confirm Password" }),
          /* @__PURE__ */ jsx("input", { type: "password", id: "confirmPassword", value: confirmPassword, onChange: (e2) => setConfirmPassword(e2.target.value), placeholder: "Enter the same password again", disabled: isLoading, required: true, minLength: 8 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "button-group", children: [
          /* @__PURE__ */ jsx("button", { type: "button", onClick: onBack, className: "secondary-button", disabled: isLoading, children: "Back" }),
          /* @__PURE__ */ jsx("button", { type: "submit", disabled: isLoading, className: "primary-button", children: isLoading ? "Creating..." : "Create Wallet" })
        ] })
      ] })
    ] });
  }
  if (step === "seed") {
    return /* @__PURE__ */ jsx(SeedPhraseBackupModal, { mnemonic, onConfirm: handleSeedConfirm, onBack: () => setStep("password"), isLoading });
  }
  return null;
};
...
const getIconUrl = (icon, fallback) => {
  if (icon)
...
const WalletContent = ({
  ...
  const formatBalance = (balance2) => parseFloat(balance2 || "0").toFixed(4);
  const chainId = selectedNetwork == null ? void 0 : selectedNetwork.chainId;
  const balance = chainId ? selectedAccount == null ? void 0 : selectedAccount.balances[chainId] : null;
  const formatted = balance ? formatBalance(balance) : "0.0000";
  const handleCopyAddress = () => {
    if (selectedAccount == null ? void 0 : selectedAccount.address) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "wallet-card", children: [
    /* @__PURE__ */ jsx("div", { className: "wallet-accent animated-gradient" }),
    /* @__PURE__ */ jsx("img", { src: logoUrl, alt: "FreoBus Logo", className: "wallet-watermark bg" }),
    /* @__PURE__ */ jsxs("div", { className: "wallet-header-row", children: [
      /* @__PURE__ */ jsxs("div", { className: "network-pill", onClick: () => setShowNetworkDropdown(!showNetworkDropdown), tabIndex: 0, children: [
        /* @__PURE__ */ jsx("img", { src: getIconUrl(selectedNetwork == null ? void 0 : selectedNetwork.icon, "icons/ethereum.svg"), alt: "network" }),
        /* @__PURE__ */ jsx("span", { children: (selectedNetwork == null ? void 0 : selectedNetwork.name) || "Network" }),
        /* @__PURE__ */ jsx("span", { className: "chevron", children: "▼" }),
        showNetworkDropdown && /* @__PURE__ */ jsx("div", { className: "network-dropdown", children: /* @__PURE__ */ jsxs("div", { className: "network-dropdown-item active", children: [
          /* @__PURE__ */ jsx("img", { src: getIconUrl(selectedNetwork == null ? void 0 : selectedNetwork.icon, "icons/ethereum.svg"), alt: "network" }),
          /* @__PURE__ */ jsx("span", { children: (selectedNetwork == null ? void 0 : selectedNetwork.name) || "Ethereum" }),
          /* @__PURE__ */ jsx("span", { className: "check", children: "✓" })
        ] }) })
      ] }),
      /* @__PURE__ */ jsx("button", { className: "menu-btn", onClick: () => setShowMenu(!showMenu), tabIndex: 0, "aria-label": "Account menu", children: /* @__PURE__ */ jsx("span", { className: "menu-icon", children: "⋮" }) }),
      showMenu && /* @__PURE__ */ jsxs("div", { className: "account-menu-dropdown", children: [
        /* @__PURE__ */ jsx("div", { className: "account-menu-item", children: "Rename" }),
        /* @__PURE__ */ jsx("div", { className: "account-menu-item", children: "Export" }),
        /* @__PURE__ */ jsx("div", { className: "account-menu-item", children: "View on Explorer" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "account-identicon-row", children: [
      (selectedAccount == null ? void 0 : selectedAccount.address) && makeBlockie(selectedAccount.address),
      /* @__PURE__ */ jsx("span", { className: "wallet-account-name", children: (selectedAccount == null ? void 0 : selectedAccount.name) || "Account" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "address-row", children: /* @__PURE__ */ jsxs("span", { className: "wallet-account-address", onClick: handleCopyAddress, title: "Copy address", style: {
      cursor: "pointer",
      position: "relative",
      marginLeft: 0
    }, onMouseEnter: () => setShowTooltip(!!copyStatus), onMouseLeave: () => setShowTooltip(false), children: [
      (selectedAccount == null ? void 0 : selectedAccount.address) ? formatAddress(selectedAccount.address) : "",
      /* @__PURE__ */ jsx("span", { className: "copy-icon", style: {
        marginLeft: 4
      }, children: "📋" }),
      showTooltip && /* @__PURE__ */ jsx("span", { className: "copy-tooltip", children: copyStatus || "Copy" })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "header-divider" }),
    /* @__PURE__ */ jsxs("div", { className: "wallet-balance", children: [
      /* @__PURE__ */ jsxs("div", { className: "wallet-balance-main", children: [
        formatted,
        " ",
        (selectedNetwork == null ? void 0 : selectedNetwork.currencySymbol) || "ETH"
      ] }),
      /* @__PURE__ */ jsx("div", { className: "wallet-balance-fiat", children: "$0.00 USD" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "wallet-actions", children: [
      /* @__PURE__ */ jsxs("button", { className: "action-btn", title: "Swap", children: [
        /* @__PURE__ */ jsx("span", { children: "⇄" }),
        /* @__PURE__ */ jsx("div", { children: "Swap" })
      ] }),
      /* @__PURE__ */ jsxs("button", { className: "action-btn", title: "Buy", children: [
        /* @__PURE__ */ jsx("span", { children: "↓" }),
        /* @__PURE__ */ jsx("div", { children: "Buy" })
      ] }),
      /* @__PURE__ */ jsxs("button", { className: "action-btn", title: "Send", children: [
        /* @__PURE__ */ jsx("span", { children: "↑" }),
        /* @__PURE__ */ jsx("div", { children: "Send" })
      ] }),
      /* @__PURE__ */ jsxs("button", { className: "action-btn", title: "Receive", children: [
        /* @__PURE__ */ jsx("span", { children: "⤓" }),
        /* @__PURE__ */ jsx("div", { children: "Receive" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "wallet-tabs", children: [
      /* @__PURE__ */ jsx("button", { className: activeTab === "tokens" ? "active" : "", onClick: () => setActiveTab("tokens"), children: "Tokens" }),
      /* @__PURE__ */ jsx("button", { className: activeTab === "nfts" ? "active" : "", onClick: () => setActiveTab("nfts"), children: "NFTs" }),
      /* @__PURE__ */ jsx("button", { className: activeTab === "activity" ? "active" : "", onClick: () => setActiveTab("activity"), children: "Activity" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "wallet-tab-content", children: [
      activeTab === "tokens" && /* @__PURE__ */ jsx("div", { className: "wallet-token-list", children: /* @__PURE__ */ jsxs("div", { className: "wallet-token-item", children: [
        /* @__PURE__ */ jsx("img", { src: getIconUrl(void 0, "icons/ethereum.svg"), alt: "ETH" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "wallet-token-name", children: "Ethereum" }),
          /* @__PURE__ */ jsxs("div", { className: "wallet-token-balance", children: [
            formatted,
            " ",
            (selectedNetwork == null ? void 0 : selectedNetwork.currencySymbol) || "ETH"
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "wallet-token-value", children: "$0.00" })
      ] }) }),
      activeTab === "nfts" && /* @__PURE__ */ jsx("div", { className: "wallet-empty-state", children: "No NFTs found" }),
      activeTab === "activity" && /* @__PURE__ */ jsx("div", { className: "wallet-empty-state", children: "No activity yet" })
    ] })
  ] });
};
...
const UnlockWalletModal = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "card", style: {
    ...
    /* @__PURE__ */ jsx("div", { className: "accent-bar" }),
    /* @__PURE__ */ jsx("h2", { children: "Unlock Your Wallet" }),
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
      error && /* @__PURE__ */ jsx("div", { className: "error-message", children: error }),
      /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "unlock-password", children: "Password" }),
        /* @__PURE__ */ jsxs("div", { style: {
          display: "flex",
          alignItems: "center",
          gap: 8
        }, children: [
          /* @__PURE__ */ jsx("input", { type: showPassword ? "text" : "password", id: "unlock-password", value: password, onChange: (e2) => setPassword(e2.target.value), placeholder: "Enter your password", required: true, disabled: isLoading, style: {
            flex: 1
          } }),
          /* @__PURE__ */ jsx("button", { type: "button", className: "secondary-button", style: {
            padding: "6px 10px",
            fontSize: "0.95em",
            minWidth: 0
          }, onClick: () => setShowPassword((v2) => !v2), tabIndex: -1, children: showPassword ? "Hide" : "Show" })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "button-group", children: /* @__PURE__ */ jsx("button", { type: "submit", className: "primary-button", disabled: isLoading || !password, children: isLoading ? "Unlocking..." : "Unlock Wallet" }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { style: {
      textAlign: "center",
      marginTop: 8
    }, children: [
      /* @__PURE__ */ jsx("button", { className: "secondary-button", style: {
        fontSize: "0.95em",
        padding: "4px 10px",
        minWidth: 0
      }, onClick: onForgot, children: "Forgot your password?" }),
      failedAttempts >= MAX_ATTEMPTS && /* @__PURE__ */ jsxs("div", { style: {
        marginTop: 12
      }, children: [
        /* @__PURE__ */ jsx("button", { className: "secondary-button", style: {
          fontSize: "0.95em",
          ...
          color: "#b38600",
          borderColor: "#FFD700"
        }, onClick: onForgot, children: "Restore with Seed Phrase" }),
        /* @__PURE__ */ jsx("div", { style: {
          fontSize: "0.92em",
          color: "#b38600",
          marginTop: 4
        }, children: "Too many failed attempts? Restore your wallet using your seed phrase." })
      ] })
    ] })
  ] });
};
...
const RestoreWallet = ({
  ...
  const handleWordChange = (idx, value) => {
    setWords((words2) => words2.map((w2, i) => i === idx ? value.replace(/\s/g, "") : w2));
  };
  const validateMnemonic = (words2) => words2.every((w2) => w2.trim().length > 0);
  const handleSubmit = async (e2) => {
    e2.preventDefault();
  ...
  return /* @__PURE__ */ jsxs("div", { className: "restore-wallet card", style: {
    maxWidth: 400,
    margin: "0 auto",
    marginTop: 32
  }, children: [
    ...
    /* @__PURE__ */ jsx("h2", { style: {
      ...
      textAlign: "center",
      marginBottom: 8
    }, children: "Restore Your Wallet" }),
    /* @__PURE__ */ jsx("p", { className: "subtitle", style: {
      textAlign: "center",
      color: "#008080",
      marginBottom: 12
    }, children: "Enter your 12-word seed phrase to restore your wallet" }),
    /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
      (error || validationError) && /* @__PURE__ */ jsx("div", { className: "error-message", role: "alert", children: error || validationError }),
      /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
        /* @__PURE__ */ jsx("label", { style: {
          color: "#008080",
          fontWeight: 600
        }, children: "Seed Phrase" }),
        /* @__PURE__ */ jsx("div", { style: gridStyle, children: words.map((word, idx) => /* @__PURE__ */ jsx("input", { type: "text", style: inputStyle, value: word, onChange: (e2) => handleWordChange(idx, e2.target.value), disabled: isRestoring, autoComplete: "off", spellCheck: false, inputMode: "text", placeholder: String(idx + 1), maxLength: 16 }, idx)) }),
        /* @__PURE__ */ jsx("small", { className: "input-help", children: "Enter the 12 words in order, one per box" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
        ...
        /* @__PURE__ */ jsx("input", { type: "password", id: "password", value: password, onChange: (e2) => setPassword(e2.target.value), placeholder: "Create a new password (min. 8 characters)", disabled: isRestoring, required: true, minLength: 8, style: inputStyle }),
        /* @__PURE__ */ jsx("small", { className: "input-help", children: "This password will be used to protect your restored wallet" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
        ...
        /* @__PURE__ */ jsx("input", { type: "password", id: "confirmPassword", value: confirmPassword, onChange: (e2) => setConfirmPassword(e2.target.value), placeholder: "Enter the same password again", disabled: isRestoring, required: true, minLength: 8, style: inputStyle })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "button-group", style: {
        marginTop: 18
      }, children: /* @__PURE__ */ jsx("button", { type: "submit", className: "primary-button", disabled: isRestoring, style: {
        width: "100%"
      }, children: isRestoring ? "Restoring..." : "Restore Wallet" }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "warning-banner", style: {
      marginTop: 18
    }, children: [
      /* @__PURE__ */ jsx("span", { role: "img", "aria-label": "warning", children: "⚠️" }),
...
const WalletIcon = () => /* @__PURE__ */ jsxs("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", style: {
  marginRight: 6
}, children: [
  /* @__PURE__ */ jsx("rect", { x: "3", y: "7", width: "18", height: "10", rx: "3", fill: "#008080", stroke: "#FFD700", strokeWidth: "2" }),
  /* @__PURE__ */ jsx("circle", { cx: "17", cy: "12", r: "1.5", fill: "#FFD700", stroke: "#fff", strokeWidth: "1" })
] });
const KeyIcon = () => /* @__PURE__ */ jsxs("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", style: {
  marginRight: 6
}, children: [
  /* @__PURE__ */ jsx("circle", { cx: "15", cy: "9", r: "3", fill: "#008080", stroke: "#FFD700", strokeWidth: "2" }),
  /* @__PURE__ */ jsx("rect", { x: "2", y: "15", width: "10", height: "3", rx: "1.5", fill: "#008080", stroke: "#FFD700", strokeWidth: "2" }),
  /* @__PURE__ */ jsx("circle", { cx: "6", cy: "16.5", r: "1", fill: "#FFD700", stroke: "#fff", strokeWidth: "1" })
] });
const Welcome = () => {
  var _a;
  const [showCreateWallet, setShowCreateWallet] = reactExports.useState(false);
  const [showWalletDashboard, setShowWalletDashboard] = reactExports.useState(false);
  const [showUnlock, setShowUnlock] = reactExports.useState(false);
  const [showRestoreWallet, setShowRestoreWallet] = reactExports.useState(false);
  const [walletState, setWalletState] = reactExports.useState(null);
  ...
  const handleWalletCreated = (state) => {
  ...
  const handleRestore = async (password, mnemonic) => {
    ...
    try {
      ...
      if (response && response.success && response.walletState) {
        ...
        setRestoreError((response == null ? void 0 : response.error) || "Failed to restore wallet");
      }
    } catch (err) {
      setRestoreError((err == null ? void 0 : err.message) || "Failed to restore wallet");
    }
  };
  const logoUrl = chrome.runtime.getURL("icons/logo.svg");
  ...
  if (showWalletDashboard) {
    return /* @__PURE__ */ jsx(WalletContent, { selectedAccount: ((_a = walletState == null ? void 0 : walletState.accounts) == null ? void 0 : _a[0]) || null, selectedNetwork: (walletState == null ? void 0 : walletState.selectedNetwork) || null });
  }
  if (showUnlock) {
    return /* @__PURE__ */ jsx(UnlockWalletModal, { onUnlock: handleUnlock, onForgot: handleForgot, onSuccess: handleUnlockSuccess });
  }
  if (showCreateWallet) {
    return /* @__PURE__ */ jsx(CreateWallet, { onBack: () => setShowCreateWallet(false), onWalletCreated: handleWalletCreated });
  }
  if (showRestoreWallet) {
    return /* @__PURE__ */ jsx(RestoreWallet, { onRestore: handleRestore, error: restoreError });
  }
  return /* @__PURE__ */ jsx("div", { style: containerStyle, children: /* @__PURE__ */ jsxs("div", { style: cardStyle, children: [
    ...
    /* @__PURE__ */ jsx("div", { style: logoSectionStyle, children: /* @__PURE__ */ jsx("img", { src: logoUrl, alt: "FreoWallet Logo", style: logoStyle }) }),
    /* @__PURE__ */ jsx("div", { style: subtitleSectionStyle, children: /* @__PURE__ */ jsx("div", { style: subtitleStyle, children: "Your MasterKey" }) }),
    /* @__PURE__ */ jsxs("div", { style: buttonContainerStyle, children: [
      /* @__PURE__ */ jsxs("button", { style: connectBtn.hover ? {
        ...buttonStyle,
        ...buttonHoverStyle
      } : buttonStyle, onClick: handleConnect, onMouseEnter: connectBtn.onMouseEnter, onMouseLeave: connectBtn.onMouseLeave, children: [
        /* @__PURE__ */ jsx(WalletIcon, {}),
        " Connect Wallet"
      ] }),
      /* @__PURE__ */ jsx("div", { style: forgotStyle, onClick: handleForgot, children: "Forgot your password?" }),
      /* @__PURE__ */ jsxs("button", { style: createBtn.hover ? {
        ...buttonStyle,
        ...buttonHoverStyle,
        marginTop: "2em"
      } : {
        ...buttonStyle,
        marginTop: "2em"
      }, onClick: handleCreate, onMouseEnter: createBtn.onMouseEnter, onMouseLeave: createBtn.onMouseLeave, children: [
        /* @__PURE__ */ jsx(KeyIcon, {}),
        " Create Wallet"
      ] }),
      /* @__PURE__ */ jsxs("div", { style: trustBadgeStyle, children: [
        /* @__PURE__ */ jsx("span", { role: "img", "aria-label": "lock", children: "🔒" }),
...
if (plasmoRoot) {
  createRoot(plasmoRoot).render(/* @__PURE__ */ jsx(Welcome, {}));
}
